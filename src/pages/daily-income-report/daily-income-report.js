 ...
 */
var DailyIncomeReportPage = /** @class */ (function () {
    function DailyIncomeReportPage(navCtrl, navParams, toastCtrl, modalCtrl) {
    ...
    DailyIncomeReportPage.prototype.deleteItem = function (ID) {
    ...
    DailyIncomeReportPage.prototype.editItem = function (ID) {
        this.navCtrl.push(Edit, { 'id': ID }, { animate: true, direction: 'forward' });
    };
    DailyIncomeReportPage.prototype.ionViewDidLoad = function () {
    ...
    ], DailyIncomeReportPage.prototype, "barCanvas", void 0);
    DailyIncomeReportPage = __decorate([
        IonicPage(),
        Component({
    ...
    return DailyIncomeReportPage;
}());
export { DailyIncomeReportPage };
//# sourceMappingURL=daily-income-report.js.map