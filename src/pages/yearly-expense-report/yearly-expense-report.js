...
var YearlyExpenseReportPage = /** @class */ (function () {
    function YearlyExpenseReportPage(navCtrl, navParams, toastCtrl, modalCtrl, popoverCtrl) {
    ...
    YearlyExpenseReportPage.prototype.deleteItem = function (ID) {
    ...
    YearlyExpenseReportPage.prototype.editItem = function (ID) {
        this.navCtrl.push(Edit, { 'id': ID }, { animate: true, direction: 'forward' });
    };
    YearlyExpenseReportPage.prototype.ionViewDidLoad = function () {
    ...
    YearlyExpenseReportPage.prototype.presentPopover = function (myEvent) {
        var popover = this.popoverCtrl.create(PopoverExpenseYearPage);
        popover.present({
            ev: myEvent
        });
    };
    ...
    ], YearlyExpenseReportPage.prototype, "barCanvas", void 0);
    YearlyExpenseReportPage = __decorate([
        IonicPage(),
        Component({
    ...
    return YearlyExpenseReportPage;
}());
export { YearlyExpenseReportPage };
//# sourceMappingURL=yearly-expense-report.js.map