 ...
 */
var PopoverExpenseMonthPage = /** @class */ (function () {
    function PopoverExpenseMonthPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    PopoverExpenseMonthPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PopoverExpenseMonthPage');
    };
    PopoverExpenseMonthPage.prototype.monthName = function (monthValue) {
        this.navCtrl.push(MonthwiseExpenseReportPage, { 'monthName': monthValue }, { animate: true, direction: 'forward' });
    };
    PopoverExpenseMonthPage = __decorate([
        IonicPage(),
        Component({
    ...
    return PopoverExpenseMonthPage;
}());
export { PopoverExpenseMonthPage };
//# sourceMappingURL=popover-expense-month.js.map